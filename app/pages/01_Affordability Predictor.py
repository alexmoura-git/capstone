...
if st.sidebar.button('PREDICT'):
    ...
    st.write(f'The Median Rent income in **{neighborhood} - {city}** is **{median_rent:.2f} Dollars**. The Predicted Income for this property is $ **{predicted_monthly_income:.2f} Dollars**')
    if predicted_monthly_income>median_rent:
        ...
        message = "Median Rent is still higher than the monthly income for this property, which makes unlikely that this rental is putting pressure in the local rental prices. The red region in the chart below shows the area in which property income are more liklely to be competing with local housing."
