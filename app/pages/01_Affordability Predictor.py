...
if st.sidebar.button('PREDICT'):
    ...
    st.write(f'The Median Rent income in **{neighborhood} - {city}** is **{median_rent:.2f} USD**. The Predicted Income for this property is $ **{predicted_monthly_income:.2f} USD**')
